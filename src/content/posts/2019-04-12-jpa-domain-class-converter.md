...
description: >-
  도메인 클래스 컨버터에 대해서 알아보자. 도메인 클래스 컨버터는 Spring Data Jpa를 사용하게 되면 Common 프로젝트에 있는
  클래스 인데, 간단하게, id 엔티티 타입으로 변환 해주거나, 엔티티 id 로 변환해 주는 컨버터를 제공해준다.
date: '2019-04-12T00:00:00+09:00'
permalink: /2019/04/12/jpa-domain-class-converter/
section: backend
hub: jpa
type: reference
level: 중급
