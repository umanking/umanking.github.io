...
description: >-
  JavaScript의 배열 메서드 중에서 가장 강력하면서도 다소 난해한 메서드인 'reduce'에 대해 알아보겠습니다. Reduce 메서드는
  배열의 각 요소를 순차적으로 처리하면서 배열을 단일 값으로 줄여주는 함수입니다.
date: '2023-08-04T21:14:00+09:00'
permalink: /2023/08/04/js-practice-reduce/
section: web
hub: javascript
type: reference
level: 중급
