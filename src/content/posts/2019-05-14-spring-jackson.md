...
description: >-
  오늘은 Jackson 어노테이션에 대해서 알아보도록 하겠습니다. 다음과 같이 스프링 부트를 사용하면 spring boot starter
  web 의존성에 jackson databind 라이브러리가 추가 되어 있다.
date: '2019-05-14T00:00:00+09:00'
permalink: /2019/05/14/spring-jackson/
section: backend
hub: spring
type: reference
level: 중급
