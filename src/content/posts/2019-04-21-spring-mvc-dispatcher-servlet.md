...
description: >-
  DispatcherSevlet의 기본전략과 여러가지 유형에 대해서 알아보자. DispatcherServlet 의 초기화 전략은 다음과 같다.
  초기화 구조는 거의다 비슷하기 때문에 여기에서는 initViewResolvers(context) 를 살펴보자.
date: '2019-04-21T00:00:00+09:00'
permalink: /2019/04/21/spring-mvc-dispatcher-servlet/
section: backend
hub: spring
type: reference
level: 중급
