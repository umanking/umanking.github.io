...
description: >-
  JPA에서 쿼리 메서드를 정의하는 방법에 대해서 알아보자. CREATE 메서드 이름을 분석해서 만듬 USE DECLARED QUERY 미리
  정의해둔 쿼리를 찾아서 사용 CREATE IF NOT FOUND 기본 전략 미리 정의해둔 쿼리 찾아서 없으면 메
date: '2019-04-12T00:00:00+09:00'
permalink: /2019/04/12/jpa-query-method-lookup-stratege/
section: backend
hub: jpa
type: reference
level: 중급
